...
//         console.log("Файл scss/fonts.scss вже існує. Для оновлення файлу його необхідно видалити");
//       }
//     }
//   });

//   return app.gulp.src(app.path.srcFolder); // Вернулось значение `gulp.src()`
// };
